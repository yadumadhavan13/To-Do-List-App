...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String TODOITEM = "com.sanam.MainActivity";
    ...
    public static final String SHARED_PREF_DATA_SET_CHANGED = "sanam.acagild.datasetchanged";
    public static final String CHANGE_OCCURED = "sanam.acagild.changeoccured";
    private int mTheme = -1;
    private String theme = "name_of_the_theme";
    public static final String THEME_PREFERENCES = "sanam.acagild.themepref";
    public static final String RECREATE_ACTIVITY = "sanam.acagild.recreateactivity";
    public static final String THEME_SAVED = "sanam.acagild.savedtheme";
    public static final String DARKTHEME = "sanam.acagild.darktheme";
    public static final String LIGHTTHEME = "sanam.acagild.lighttheme";
...
//        Log.d("Check", "createAlarm "+requestCode+" time: "+timeInMillis+" PI "+pi.toString());
    }
    private void deleteAlarm(Intent i, int requestCode){
        if(doesPendingIntentExist(i, requestCode)){
            ...
            Log.d("Sanam", "PI Cancelled " + doesPendingIntentExist(i, requestCode));
        }
    }
