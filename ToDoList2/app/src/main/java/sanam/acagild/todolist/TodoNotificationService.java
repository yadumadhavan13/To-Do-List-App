...
public class TodoNotificationService extends IntentService {
    public static final String TODOTEXT = "sanam.acagild.todolist";
    public static final String TODOUUID = "sanam.acagild.todonotificationserviceuuid";
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        Log.d("SanamKader", "onHandleIntent called");
